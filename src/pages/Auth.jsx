...
const Auth = () => {
  ...
  const isFormFilled = email && password.length>=6;

  return (
    <div className="relative py-12 container pt-24 sm:max-w-xl sm:mx-auto">
      <div className="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        <div className="max-w-md mx-auto">
          <div className="flex items-center space-x-5 justify-center">
            <h1 className="text-3xl font-semibold text-[#2c3d8f]">Medico</h1>
          </div>
          <div className="mt-5">
            <label
            ...
            />
            <p  className="text-red-500 text-sm mt-0">Password should be at least 6 characters</p>
          </div>
